...
public class Robots{
    ...
    //Metodos solicitados
    public void atacar(Robot otroRobot){//Note que aca ya estamos suponiendo que existen dos objetos que son los robots que estaran activos para el encuentro por realizar//
